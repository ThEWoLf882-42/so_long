...
/*   Updated: 2023/02/15 14:55:36 by agimi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	dloop(t_all *all)
{
	...
	if (i >= 0 && i <= 8)
		all->player.player = mlx_texture_to_image(all->mlx, all->mv.down.d2);
	if (i >= 8 && i <= 16)
		all->player.player = mlx_texture_to_image(all->mlx, all->mv.down.d1);
	if (i >= 16 && i <= 24)
		all->player.player = mlx_texture_to_image(all->mlx, all->mv.down.d0);
	if (i >= 24 && i <= 32)
		all->player.player = mlx_texture_to_image(all->mlx, all->mv.down.d1);
	if (i == 32)
		i = 0;
